...
namespace Horseshoe.NET.WebForms.Bootstrap4
{
    public class WebFormsBootstrapAlert : WebControl
    {
        ...
        public WebFormsBootstrapAlert(BootstrapAlert bootstrapAlert)
        {
            ...
            Fade = bootstrapAlert.Fade;
            Show = bootstrapAlert.Show;
        ...
        {
            // alert ui
            writer.AddAttribute(HtmlTextWriterAttribute.Class, "alert alert-" + AlertType.ToString().ToLower() + (IsCloseable ? " alert-dismissible" : "") + (Fade ? " fade" : "") + (Show ? " show" : ""));
