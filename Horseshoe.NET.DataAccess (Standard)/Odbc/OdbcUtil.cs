...
namespace Horseshoe.NET.DataAccess.Odbc
{
    public static class OdbcUtil
    {
        ...
        public static string GetDefaultConnectionString(out string announcePrefix)
        {
            ...
            if (Settings.DefaultDataSource != null)
            {
                ...
                if (Settings.DefaultCredentials.HasValue)
                {
                    ...
                    {
                        sb.Append(";PWD=" + DataUtil.Decrypt(Settings.DefaultCredentials.Value.Password));
                    }
        ...
        public static string WhichConnectionString(OdbcConnectionInfo connectionInfo = null, bool announce = false)
        {
        ...
        public static OdbcConnection LaunchConnection(OdbcConnectionInfo connectionInfo)
        {
