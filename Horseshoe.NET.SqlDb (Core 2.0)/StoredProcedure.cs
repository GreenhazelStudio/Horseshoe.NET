...
namespace Horseshoe.NET.SqlDb
{
    internal class StoredProcedure
    {
        ...
        internal static void Validate(string procedureName, IEnumerable<SqlParameter> parameters = null, SqlConnectionInfo connectionInfo = null)
        {
        ...
        internal static IEnumerable<SqlParameter> GetParameters(string procedureName, SqlConnectionInfo connectionInfo = null)
        {
            using (var conn = SqlUtil.LaunchConnection(connectionInfo))
            {
                conn.Open();
